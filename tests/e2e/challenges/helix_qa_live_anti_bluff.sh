...
# Lower bound is 61.
# Plus HCQA-092 (binding-validation-400) + HCQA-093 (1MB-payload-201)
# + HCQA-094 (unauthorized-401) = 127 evidence files.
if [ "$EV_COUNT" -lt 127 ]; then
    echo "  FAIL: only $EV_COUNT evidence files (expected ≥ 127)"; exit 1
fi
