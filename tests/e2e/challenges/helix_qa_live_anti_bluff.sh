...
# Lower bound is 61.
# Plus 5 not-found-→-404 + 1 heartbeat-bogus-404 (HCQA-070) = 101.
# Lower bound is 101; any fewer means coverage lost.
if [ "$EV_COUNT" -lt 101 ]; then
    echo "  FAIL: only $EV_COUNT evidence files (expected ≥ 101)"; exit 1
fi
