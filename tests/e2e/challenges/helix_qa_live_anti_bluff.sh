...
# Lower bound is 61.
# Plus HCQA-071-PRE-W + HCQA-071 (dup-hostname-409) + HCQA-072
# (workflow-bogus-404) = 104 evidence files.
if [ "$EV_COUNT" -lt 104 ]; then
    echo "  FAIL: only $EV_COUNT evidence files (expected ≥ 104)"; exit 1
fi
