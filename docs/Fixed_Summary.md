...
|---|---|---|
| Bug | 30 | `Fixed (→ Fixed.md)` |
| Feature | 69 | `Implemented (→ Fixed.md)` |
| Task | 15 | `Completed (→ Fixed.md)` |
| Obsolete | 1 | `Obsolete (→ Fixed.md)` (§11.4.90 — terminal Status, orthogonal to Type) |

**Total closed items**: 114 (counted directly from the `docs/Fixed.md` closure table).
...
*Last regenerated: 2026-06-16 by `scripts/generate_fixed_summary.sh`. HTML/PDF exports via `scripts/regenerate-tracker-exports.sh`.*
