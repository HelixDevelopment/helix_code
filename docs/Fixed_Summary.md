...
| Feature | 49 | `Implemented (→ Fixed.md)` |
| Task | 6 | `Completed (→ Fixed.md)` |

**Total closed items**: 61 (in the round-system tracker; pre-round closures tracked separately in `docs/improvements/PROGRESS.md`).
