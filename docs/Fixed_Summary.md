...
| Feature | 51 | `Implemented (→ Fixed.md)` |
| Task | 6 | `Completed (→ Fixed.md)` |

**Total closed items**: 63 (in the round-system tracker; pre-round closures tracked separately in `docs/improvements/PROGRESS.md`).
