...
| Feature | 37 | `Implemented (→ Fixed.md)` |
| Task | 6 | `Completed (→ Fixed.md)` |

**Total closed items**: 49 (in the round-system tracker; pre-round closures tracked separately in `docs/improvements/PROGRESS.md`).
