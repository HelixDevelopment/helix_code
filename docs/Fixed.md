...
| 2026-05-19 | helix_code/internal/auth × up to 10 migration (Phase 4 round 39) | Feature | Implemented (→ Fixed.md) | 146 | 3b5ced5 | First helix_code/internal/* package migrated; formal report pending |
