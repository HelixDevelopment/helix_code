...
**Last regenerated:** 2026-05-15 (mechanical, via `scripts/regenerate-coverage-ledger.sh` — round tag: `close-out-18-regen`)
...
- **UNCONFIRMED: cells preserved:** 39 (from prior edition).
