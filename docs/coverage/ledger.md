...
| submodules/doc_processor | VERIFIED | 0 |  |
| submodules/helix_llm | VERIFIED | 0 |  |
| submodules/helix_memory | VERIFIED | 0 |  |
| submodules/helix_specifier | VERIFIED | 0 |  |
| submodules/llm_orchestrator | VERIFIED | 0 |  |
| submodules/llm_provider | VERIFIED | 0 |  |
| submodules/llms_verifier | VERIFIED | 0 |  |
| submodules/models | VERIFIED | 0 |  |
| submodules/vision_engine | VERIFIED | 0 |  |
| submodules/agentic | VERIFIED | 0 |  |
| submodules/auth | VERIFIED | 0 |  |
| submodules/auto_temp | VERIFIED | 0 |  |
| submodules/background_tasks | VERIFIED | 0 |  |
| submodules/benchmark | VERIFIED | 0 |  |
| submodules/cache | VERIFIED | 0 |  |
| submodules/claritas | VERIFIED | 0 |  |
| submodules/concurrency | VERIFIED | 0 |  |
| submodules/config | VERIFIED | 0 |  |
| submodules/conversation | VERIFIED | 0 |  |
| submodules/database | VERIFIED | 0 |  |
| submodules/doc_processor | VERIFIED | 0 |  |
| submodules/document | VERIFIED | 0 |  |
| submodules/embeddings | VERIFIED | 0 |  |
| submodules/event_bus | VERIFIED | 0 |  |
| submodules/filesystem | VERIFIED | 0 |  |
| submodules/formatters | VERIFIED | 0 |  |
| submodules/gandalf_solutions | VERIFIED | 0 |  |
| submodules/hyper_tune | VERIFIED | 0 |  |
| submodules/i18n | VERIFIED | 0 |  |
| submodules/i_llm | VERIFIED | 0 |  |
| submodules/lazy | VERIFIED | 0 |  |
| submodules/leak_hub | VERIFIED | 0 |  |
| submodules/llm_ops | VERIFIED | 0 |  |
| submodules/llm_orchestrator | VERIFIED | 0 |  |
| submodules/llm_provider | VERIFIED | 0 |  |
| submodules/mcp_module | VERIFIED | 0 |  |
| submodules/memory | VERIFIED | 0 |  |
| submodules/messaging | VERIFIED | 0 |  |
| submodules/middleware | VERIFIED | 0 |  |
| submodules/models | VERIFIED | 0 |  |
| submodules/normalize | VERIFIED | 0 |  |
| submodules/observability | VERIFIED | 0 |  |
| submodules/optimization | VERIFIED | 0 |  |
| submodules/ouroborous | VERIFIED | 0 |  |
| submodules/planning | VERIFIED | 0 |  |
| submodules/plinius_common | VERIFIED | 0 |  |
| submodules/plugins | VERIFIED | 0 |  |
| submodules/rag | VERIFIED | 0 |  |
| submodules/rate_limiter | VERIFIED | 0 |  |
| submodules/recovery | VERIFIED | 0 |  |
| submodules/red_team | VERIFIED | 0 |  |
| submodules/self_improve | VERIFIED | 0 |  |
| submodules/skill_registry | VERIFIED | 0 |  |
| submodules/storage | VERIFIED | 0 |  |
| submodules/streaming | VERIFIED | 0 |  |
| submodules/tool_schema | VERIFIED | 0 |  |
| submodules/toon | VERIFIED | 0 |  |
| submodules/vector_db | VERIFIED | 0 |  |
| submodules/veritas | VERIFIED | 0 |  |
| submodules/vision_engine | VERIFIED | 0 |  |
| submodules/watcher | VERIFIED | 0 |  |
...
## Sources verified 2026-05-29: internal-governance doc — no third-party-service operator instructions to cross-reference. This is HelixCode's own CONST-048 feature × invariant rollup (F01–F30); external mentions (`chromedp`/`chromium`, `bubblewrap`, `tree-sitter`, `OpenTelemetry`, Cognee) are stack-description notes attached to feature rows, not version-pinned setup instructions, and the LLM provider names in F12 (groq/openrouter/mistral/deepseek + "10 remaining") are LLMsVerifier-sourced at runtime per CONST-036 (`helixcode llm models list`) — deliberately NOT re-pinned here. Version authority per CLAUDE.md §3.1 (confirmed in-tree): inner module `go 1.26`, root `go 1.25.2`; PostgreSQL 15+; Redis 7+ — no stale build/Docker version pins in this doc to correct. Reviewed against the live tree on this date; no corrections required.
