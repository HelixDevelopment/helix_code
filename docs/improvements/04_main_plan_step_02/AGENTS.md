...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the HelixCode codebase.
...
GeneratorAgent (pkg/generator/), TransformAgent (pkg/transform/), AnalyzeAgent (pkg/analyze/), VerifyAgent (pkg/verify/), IntegrationAgent (all packages)

---

## Capability Specifications

Code generation, AST transform, static analysis, LLM integration, verification
