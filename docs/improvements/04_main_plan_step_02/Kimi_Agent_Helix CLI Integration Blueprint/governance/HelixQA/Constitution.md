# Constitution of HelixQA

**Version:** 1.0.0 | **Repository:** `github.com/HelixDevelopment/HelixQA` | **Module:** `digital.vasic.helixqa`
...
## Article VI: HelixQA-Specific Mandates

- §6.1: Anti-bluff scanning (scripts/anti-bluff-scan.sh) MUST exit non-zero on any violation.
- §6.2: Observable behaviour assertion ratio MUST be at least 60%.
- §6.3: Mutation score MUST be >= 85%.
- §6.4: Container verifier execCommand() MUST execute real commands.
...
*End of Constitution of HelixQA*
