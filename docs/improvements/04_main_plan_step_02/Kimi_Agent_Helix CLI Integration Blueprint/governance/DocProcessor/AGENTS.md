...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the DocProcessor codebase.
...
OpenAPIAgent (pkg/openapi/), ProtobufAgent (pkg/protobuf/), SyncAgent (pkg/sync/), ValidateAgent (pkg/validate/), GovernanceAgent (pkg/governance/)

---

## Capability Specifications

Spec generation, doc sync, governance generation, comment verification

---

## Integration Patterns

HelixCode (code-to-doc pipeline), HelixAgent (governance auto-update)
