...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the LLMsVerifier codebase.
...
VerifierAgent (verification/), ProviderAgent (providers/), ConfigAgent (pkg/cliagents/), AnalyticsAgent (analytics/), AuthAgent (auth/)

---

## Capability Specifications

Model verification (20+ tests), provider scoring, CLI agent generation (48 agents), subscription detection, OAuth handling
