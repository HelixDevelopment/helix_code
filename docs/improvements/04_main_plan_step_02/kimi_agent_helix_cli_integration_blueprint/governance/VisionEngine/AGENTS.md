...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the VisionEngine codebase.
...
AnalyzeAgent (pkg/analyze/), DetectAgent (pkg/detect/), OCRAgent (pkg/ocr/), MultimodalAgent (pkg/multimodal/), ProviderAgent (pkg/providers/)

---

## Capability Specifications

Image analysis, object detection, OCR, multimodal routing, provider fallback

---

## Integration Patterns

LLMProvider (vision-capable provider interface), HelixAgent (vision endpoint integration), LLMsVerifier (vision model verification)

---

## Testing Requirements Per Agent

All agents require Unit, Integration, E2E, Challenge, and Anti-Bluff tests with live vision providers
