# Constitution of VisionEngine

**Version:** 1.0.0 | **Repository:** `github.com/HelixDevelopment/VisionEngine` | **Module:** `dev.helix.visionengine`

---

## Preamble

VisionEngine provides computer vision, image analysis, and multimodal processing capabilities for the HelixAgent ecosystem. It integrates with LLM providers for vision-model-based analysis.

This Constitution is the supreme law of the VisionEngine submodule. All other governance documents (`CLAUDE.md`, `AGENTS.md`) cascade from this Constitution and MUST NOT weaken or override any article herein.
...
- §3.2: **Submodule dependencies.** VisionEngine declares its upstream and downstream submodule dependencies explicitly. Changes to integration seams MUST be contract-tested.
...
## Article VI: VisionEngine-Specific Mandates

- §6.1: All vision analysis MUST support both local processing and cloud-provider fallback.
- §6.2: Image preprocessing MUST maintain aspect ratio and respect max dimension limits.
- §6.3: Vision model capabilities MUST be verified through LLMsVerifier before inclusion.
- §6.4: Multimodal requests MUST be routed through the same fallback chain as text requests.
- §6.5: Response formats MUST be consistent across all vision providers.
...
Any submodule that imports VisionEngine MUST inherit VisionEngine's testing and anti-bluff requirements for all integration points.
...
*End of Constitution of VisionEngine*
