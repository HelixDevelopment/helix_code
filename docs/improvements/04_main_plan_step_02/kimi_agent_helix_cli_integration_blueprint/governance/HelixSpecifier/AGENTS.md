...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the HelixSpecifier codebase.
...
ClassifierAgent (pkg/intent/), CeremonyAgent (pkg/ceremony/), SpecKitAgent (pkg/speckit/), SuperpowersAgent (pkg/superpowers/), GSDAgent (pkg/gsd/), MemoryAgent (pkg/memory/)

---

## Capability Specifications

Effort classification, ceremony scaling, SpecKit phases, parallel execution, Nyquist TDD, spec memory

---

## Integration Patterns

HelixAgent (auto-activation via work granularity), DebateOrchestrator (DebateFunc injection)

---

## Testing Requirements Per Agent

All agents require Unit, Integration, E2E, Challenge, and Anti-Bluff tests
...
*End of AGENTS.md — HelixSpecifier*
