...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the Challenges codebase.
...
RunnerAgent (pkg/runner/), AggregatorAgent (pkg/aggregator/), ValidatorAgent (pkg/validator/), ScriptAgent (scripts/)

---

## Capability Specifications

Script execution, result aggregation, validation, dependency resolution

---

## Integration Patterns

LLMsVerifier (challenge result verification), HelixQA (QA challenge integration), HelixAgent (infra challenge bridge)
