...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the LLMOrchestrator codebase.
...
RouterAgent (pkg/router/), BatchAgent (pkg/batch/), StreamAgent (pkg/stream/), MetricsAgent (pkg/metrics/), CircuitAgent (pkg/circuit/)

---

## Capability Specifications

Provider routing, request batching, streaming coordination, metrics, circuit breaker

---

## Integration Patterns

LLMProvider (provider interface dispatch), LLMsVerifier (score-based routing), HelixLLM (fallback chain coordination), HelixAgent (HTTP middleware integration)
...
*End of AGENTS.md — LLMOrchestrator*
