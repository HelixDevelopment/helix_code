...
HelixQA (digital.vasic.helixqa, Go 1.24+) provides: visual assertion engine, manual recording and playback, challenge scenario runner, anti-bluff scanner, mutation testing engine, performance SLA validation. Key packages: pkg/assertions, pkg/recording, pkg/challenges, pkg/antibluff, pkg/mutation.
...
make test-unit, make test-integration, make test-mutation, make test-antibluff
...
|-----------|-----------------|
| Upstream (this module imports) | LLMsVerifier, Challenges |
