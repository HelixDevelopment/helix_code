...
AssertionAgent (pkg/assertions/), RecordingAgent (pkg/recording/), ChallengeRunnerAgent (pkg/challenges/), AntiBluffAgent (pkg/antibluff/), MutationAgent (pkg/mutation/)

---

## Capability Specifications

Visual assertion, challenge runner, anti-bluff scan, mutation testing (>=85%), SLA validation

---

## Integration Patterns

LLMsVerifier (verification result integration), Challenges (challenge script validation), HelixAgent (QA pipeline adapter)
...
The anti-bluff scanner is the PRIMARY defence against false-confidence. It MUST be run before every release.

---

*End of AGENTS.md — HelixQA*
