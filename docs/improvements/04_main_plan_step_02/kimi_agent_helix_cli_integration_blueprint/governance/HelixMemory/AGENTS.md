...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the HelixMemory codebase.
...
FusionAgent (pkg/fusion/), RouterAgent (pkg/routing/), ConsolidationAgent (pkg/consolidation/), ClientAgent (pkg/clients/)

---

## Capability Specifications

4-backend fusion, deduplication (cosine >= 0.92), temporal queries, consolidation (sleep-time compute)

---

## Integration Patterns

Memory module (MemoryStore interface), HelixAgent (MemoryAdapter sync)

---

## Testing Requirements Per Agent

All agents require Unit, Integration, E2E, Challenge, and Anti-Bluff tests with live backends
