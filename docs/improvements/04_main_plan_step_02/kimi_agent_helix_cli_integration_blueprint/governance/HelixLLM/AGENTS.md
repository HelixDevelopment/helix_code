...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the HelixLLM codebase.
...
GatewayAgent (internal/gateway/), FallbackAgent (internal/fallback/), BrainAgent (internal/brain/), KnowledgeAgent (internal/knowledge/), AgentsLayerAgent (internal/agents/)

---

## Capability Specifications

Multi-provider fallback chain, rate limit handling, circuit breaker, memory sync, hardware profiling

---

## Integration Patterns

LLMsVerifier (ScorerBridge polling), HelixMemory (MemoryAdapter sync), HelixAgent (HTTP/3 + TLS 1.3)
