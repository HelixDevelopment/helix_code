...
This file defines agent constraints, capabilities, and collaboration rules for automated agents working on the LLMProvider codebase.
...
InterfaceAgent (pkg/provider/), GenericAgent (pkg/generic/), RegistryAgent (pkg/registry/), ConfigAgent (pkg/config/)

---

## Capability Specifications

LLM completion, streaming, health check, capabilities, config validation

---

## Integration Patterns

HelixLLM (Brain provider implementations), LLMOrchestrator (Router dispatch), HelixAgent (Provider registry)

---

## Testing Requirements Per Agent

All agents require Unit, Integration, E2E, Challenge, and Anti-Bluff tests with live providers
