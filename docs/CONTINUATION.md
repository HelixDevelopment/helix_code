...
**Last updated: 2026-05-12T23:00:00Z (Submodule test parity: 3 real fixes — added Models submodule for LLMProvider's relative-path replace, `go mod tidy` for LLMOrchestrator+Security stale checksums, Venice TestGetCapabilities switched from brittle hardcoded model IDs to shape-based substring assertions surviving Venice's catalogue rename. Every owned submodule's `go test ./...` exits 0. Meta-repo at `7c81a40`.)
