...
| HXV-001 | LLMsVerifier 18 pre-existing `tests/` failures (CLI + scoring) | Bug | Queued | 2026-05-20 | Verified pre-existing at HEAD 6d661d34; needs dedicated root-cause round (classify drift vs regression) |

**Counts**: 5 open (HXV-001 added round 319; HXC-005 closed round 318; PAN-001 closed round 302; HXC-004 closed round 200; VEN-001/HXA-001/HXA-003/HXC-002/HXL-001/HXL-002 all closed) | 4 Bugs open | 1 Task open (HXC-001 Plan-Ready) | 1 Feature open (HXC-003) | 3 BLOCKED (VEN-002 + HXQ-001 operator + HXA-002 cross-submodule coord)

*Last regenerated: 2026-05-20 (round 319 — HXV-001 added). See `docs/Issues.md` for full details + prefix convention table. PDF/HTML exports auto-regenerated via `scripts/regenerate-tracker-exports.sh`.*
