...
**Counts**: 2 open (HXA-002 closed round 342; VEN-002 closed round 340; HXQ-001 closed round 325; HXV-001 closed round 323; HXC-005 closed round 318; PAN-001 closed round 302; HXC-004 closed round 200; VEN-001/HXA-001/HXA-003/HXC-002/HXL-001/HXL-002 all closed) | 0 Bug open | 1 Task open (HXC-001 In progress) | 1 Feature open (HXC-003) | 0 BLOCKED

*Last regenerated: 2026-05-20 (round 343 — HXC-001 advanced: CONST-052 rename programme — 13 owned-org leaf submodule dirs renamed to snake_case across 3 build-verified batches; HXC-001 stays In progress for deferred submodule-entangled + parent-dir batches). See `docs/Issues.md` for full details + prefix convention table. PDF/HTML exports auto-regenerated via `scripts/regenerate-tracker-exports.sh`.*
