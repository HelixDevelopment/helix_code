...
// TestQwenProviderFullAutomation tests the Qwen provider with real API calls
func TestQwenProviderFullAutomation(t *testing.T) {
	...
	t.Run("ProviderCreation", func(t *testing.T) {
		...
		assert.Equal(t, llm.ProviderTypeQwen, provider.GetType())
	...
	t.Run("ModelListing", func(t *testing.T) {
		...
		for _, model := range models {
			assert.Equal(t, llm.ProviderTypeQwen, model.Provider)
	...
	t.Run("ErrorHandling", func(t *testing.T) {
		...
		assert.Contains(t, err.Error(), "Qwen API returned status")
	})
	...
	t.Log("✅ All Qwen provider automation tests passed!")
}

// TestQwenProviderLoadTest performs load testing with real API
...
// TestQwenProviderModelCompatibility tests all available models
...
// TestQwenProviderRateLimits tests rate limit handling
