...
func TestOpenRouterProviderFullAutomation(t *testing.T) {
	...
	if apiKey == "" {
		t.Skip("OPENROUTER_API_KEY environment variable not set, skipping real API tests")
	}
...
func TestOpenRouterProviderLoadTest(t *testing.T) {
	apiKey := os.Getenv("OPENROUTER_API_KEY")
	if apiKey == "" {
		t.Skip("OPENROUTER_API_KEY environment variable not set, skipping load test")
	}
...
func TestOpenRouterProviderModelCompatibility(t *testing.T) {
	apiKey := os.Getenv("OPENROUTER_API_KEY")
	if apiKey == "" {
		t.Skip("OPENROUTER_API_KEY environment variable not set, skipping model compatibility test")
	}
...
func TestOpenRouterProviderRateLimits(t *testing.T) {
	apiKey := os.Getenv("OPENROUTER_API_KEY")
	if apiKey == "" {
		t.Skip("OPENROUTER_API_KEY environment variable not set, skipping rate limit test")
	}
