// Package i18n declares internal/context's hardcoded-content
// abstraction per CONST-046 (round-151 §11.4 anti-bluff sweep,
// 2026-05-18). Mirrors the "consumer defines its own Translator
// interface" pattern of rounds 93..150 (most recently internal/config
// 150, internal/commands 149, internal/cognee 148, internal/agent 147,
// internal/auth 146). Wire-in path at boot: consuming binary builds an
// *i18n.Localizer (loaded with active.en.yaml from
// internal/context/i18n/bundles), wraps it in *i18nadapter.Translator,
// stores via context.SetTranslator. The package-level tr() helper
...
// Translator is the contract internal/context uses for every
