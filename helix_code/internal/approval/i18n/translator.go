// Package i18n declares internal/approval's hardcoded-content
// abstraction per CONST-046 (round-221 §11.4 anti-bluff sweep,
// 2026-05-19). Mirrors the "consumer defines its own Translator
// interface" pattern of every prior CONST-046-migrated package in
// this codebase (most recently rounds 217..220). Wire-in path at
// boot: consuming binary builds an *i18n.Localizer (loaded with
// active.en.yaml from internal/approval/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via approval.SetTranslator. The
...
// Translator is the contract internal/approval uses for every
