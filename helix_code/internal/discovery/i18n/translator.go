// Package i18n declares internal/discovery's hardcoded-content
// abstraction per CONST-046 (round-154 §11.4 anti-bluff sweep,
// 2026-05-18). Mirrors the "consumer defines its own Translator
// interface" pattern of rounds 93..153 (most recently
...
// 148, internal/agent 147, internal/auth 146).
//
// Wire-in path at boot: consuming binary builds an *i18n.Localizer
// (loaded with active.en.yaml from internal/discovery/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// discovery.SetTranslator. The package-level tr() helper falls back
...
// Translator is the contract internal/discovery uses for every
