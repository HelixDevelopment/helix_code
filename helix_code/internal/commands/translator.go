// translator.go — CONST-046 message-ID resolver seam for internal/commands.
//
// Round-149 §11.4 anti-bluff sweep (2026-05-18). Mirrors the
// "consumer defines its own Translator + tr() helper" pattern used
// by every other CONST-046-migrated package in this codebase
// (rounds 93/94/95/96/108/131/134/136-148).
package commands
...
import (
	...
	"dev.helix.code/internal/commands/i18n"
)
...
// migration minimally invasive — slash-command Execute methods
// already take their own contexts, so threading a struct-scoped
