// Package i18n declares internal/commands's hardcoded-content
// abstraction per CONST-046 (round-149 §11.4 anti-bluff sweep,
// 2026-05-18). Mirrors the "consumer defines its own Translator
// interface" pattern of rounds 93..148 (most recently internal/auth
// 146, internal/agent 147, internal/cognee 148). Wire-in path at
// boot: consuming binary builds an *i18n.Localizer (loaded with
// active.en.yaml from internal/commands/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via commands.SetTranslator. The
...
// Translator is the contract internal/commands uses for every
