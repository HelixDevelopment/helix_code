// Package i18n declares internal/tools/confirmation's
// hardcoded-content abstraction per CONST-046 (round-382 §11.4
// anti-bluff sweep, 2026-05-19). Mirrors the "consumer defines its
// own Translator interface" pattern of internal/tools/i18n
// (round-181) and every prior CONST-046-migrated package.
//
// Wire-in path at boot: consuming binary builds an *i18n.Localizer
// (loaded with active.en.yaml from
// internal/tools/confirmation/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via confirmation.SetTranslator.
...
// Translator is the contract internal/tools/confirmation uses for
