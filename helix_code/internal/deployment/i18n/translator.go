// Package i18n declares internal/deployment's hardcoded-content
// abstraction per CONST-046 (round-153 §11.4 anti-bluff sweep,
// 2026-05-18). Mirrors the "consumer defines its own Translator
// interface" pattern of rounds 93..152 (most recently
// internal/database 152, internal/context 151, internal/config 150,
// internal/commands 149). Wire-in path at boot: consuming binary
// builds an *i18n.Localizer (loaded with active.en.yaml from
// internal/deployment/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via deployment.SetTranslator. The
...
// Translator is the contract internal/deployment uses for every
