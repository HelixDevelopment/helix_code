...
var (
	...
	// loads, or templatei18n.NoopTranslator{} (loud message-ID echo) if it
	// does not. SetTranslator(nil) restores THIS — "nil = restore default"
	// means "restore correct prose", not "revert to raw-key echo".
	defaultTranslator templatei18n.Translator = templatei18n.NoopTranslator{}
...
func init() {
	tr, err := templatei18n.NewTranslator()
	if err != nil {
		fmt.Fprintf(os.Stderr,
			"internal/template i18n: embedded-bundle translator load failed; "+
