// Package i18n declares internal/template's hardcoded-content
// abstraction per CONST-046 (round-180 §11.4 anti-bluff sweep,
// 2026-05-19, Phase 4 round 73). Mirrors the "consumer defines its
// own Translator interface" pattern of rounds 93..179 (most recently
...
// 152, internal/context 151, internal/config 150).
//
// Wire-in path at boot: consuming binary builds an *i18n.Localizer
// (loaded with active.en.yaml from internal/template/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// template.SetTranslator. The package-level tr() helper falls back
...
// Translator is the contract internal/template uses for every
