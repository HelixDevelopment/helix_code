...
var (
	...
	// loads, or qualityi18n.NoopTranslator{} (loud message-ID echo) if it
	// does not. SetTranslator(nil) restores THIS — "nil = restore default"
	// means "restore correct prose", not "revert to raw-key echo".
	defaultTranslator qualityi18n.Translator = qualityi18n.NoopTranslator{}
...
func init() {
	tr, err := qualityi18n.NewTranslator()
	if err != nil {
		fmt.Fprintf(os.Stderr,
			"internal/quality i18n: embedded-bundle translator load failed; "+
