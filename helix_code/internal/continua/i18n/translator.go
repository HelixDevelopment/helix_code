// Package i18n declares internal/continua's hardcoded-content
// abstraction per CONST-046 (round-230 §11.4 anti-bluff sweep,
...
// active.en.yaml from internal/continua/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via continua.SetTranslator. The
...
// Translator is the contract internal/continua uses for every
