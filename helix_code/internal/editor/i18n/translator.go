// Package i18n declares internal/editor's hardcoded-content
// abstraction per CONST-046 (round-155 §11.4 anti-bluff sweep,
// 2026-05-18). Mirrors the "consumer defines its own Translator
// interface" pattern used by every other CONST-046-migrated package
// (rounds 93..154 — most recently internal/deployment 153/154,
// internal/discovery 154). Wire-in path at boot: consuming binary
// builds an *i18n.Localizer (loaded with active.en.yaml from
// internal/editor/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via editor.SetTranslator. The
...
// Translator is the contract internal/editor uses for every
