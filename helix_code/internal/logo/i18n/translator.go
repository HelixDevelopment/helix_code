// Package i18n declares internal/logo's hardcoded-content
// abstraction per CONST-046 (round-163 §11.4 anti-bluff sweep,
...
// (loaded with active.en.yaml from internal/logo/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// logo.SetTranslator. The package-level tr() helper falls back
...
// Translator is the contract internal/logo uses for every
