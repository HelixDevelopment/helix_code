// Package i18n declares internal/memory's hardcoded-content
// abstraction per CONST-046 (round-165 §11.4 anti-bluff sweep,
// 2026-05-19). Mirrors the "consumer defines its own Translator
// interface" pattern of rounds 93..164 (most recently
...
// 150, internal/commands 149, internal/cognee 148, internal/agent
// 147, internal/auth 146).
//
// Wire-in path at boot: consuming binary builds an *i18n.Localizer
// (loaded with active.en.yaml from internal/memory/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// memory.SetTranslator. The package-level tr() helper falls back
...
// Translator is the contract internal/memory uses for every
