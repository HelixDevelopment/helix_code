// translator.go — CONST-046 message-ID resolver seam for internal/agent.
//
// Round-147 §11.4 anti-bluff sweep (2026-05-18). Mirrors the
...
import (
	...
	"dev.helix.code/internal/agent/i18n"
)
...
// migration minimally invasive — Coordinator + BaseAgent methods
