// Package i18n declares internal/kilocode's hardcoded-content
// abstraction per CONST-046 (round-231 §11.4 anti-bluff sweep,
...
// in this codebase (most recently rounds 221..226). Wire-in path at
// boot: consuming binary builds an *i18n.Localizer (loaded with
// active.en.yaml from internal/kilocode/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via kilocode.SetTranslator. The
...
// Translator is the contract internal/kilocode uses for every
