// Package i18n declares internal/autocommit's hardcoded-content
// abstraction per CONST-046 (round-229 §11.4 anti-bluff sweep,
// 2026-05-19). Mirrors the "consumer defines its own Translator
// interface" pattern of every prior CONST-046-migrated package in
// this codebase (most recently rounds 221..228). Wire-in path at
// boot: consuming binary builds an *i18n.Localizer (loaded with
// active.en.yaml from internal/autocommit/i18n/bundles), wraps it
// in *i18nadapter.Translator, stores via autocommit.SetTranslator.
...
// Translator is the contract internal/autocommit uses for every
