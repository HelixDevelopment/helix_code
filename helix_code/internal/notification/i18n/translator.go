// Package i18n declares internal/notification's hardcoded-content
// abstraction per CONST-046 (round-167 §11.4 anti-bluff sweep,
...
// (rounds 93..166 — most recently internal/event 156). Wire-in path
// at boot: consuming binary builds an *i18n.Localizer (loaded with
// active.en.yaml from internal/notification/i18n/bundles), wraps it
// in *i18nadapter.Translator, stores via notification.SetTranslator.
...
// Translator is the contract internal/notification uses for every
