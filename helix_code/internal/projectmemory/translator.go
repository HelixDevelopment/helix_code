...
var (
	...
	// loads, or pmi18n.NoopTranslator{} (loud message-ID echo) if it
	// does not. SetTranslator(nil) restores THIS — "nil = restore default"
	// means "restore correct prose", not "revert to raw-key echo".
	defaultTranslator pmi18n.Translator = pmi18n.NoopTranslator{}
...
func init() {
	tr, err := pmi18n.NewTranslator()
	if err != nil {
		fmt.Fprintf(os.Stderr,
			"internal/projectmemory i18n: embedded-bundle translator load failed; "+
