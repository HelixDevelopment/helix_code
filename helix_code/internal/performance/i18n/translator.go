// Package i18n declares internal/performance's hardcoded-content
// abstraction per CONST-046 (round-168 §11.4 anti-bluff sweep,
...
// (loaded with active.en.yaml from internal/performance/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// performance.SetTranslator. The package-level tr() helper falls
...
// Translator is the contract internal/performance uses for every
