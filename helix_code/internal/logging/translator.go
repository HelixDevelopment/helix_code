...
// internal/logging.
//
// Round-162 §11.4 anti-bluff sweep (2026-05-19). Mirrors the
...
// internal/logging/ at HEAD. The package's user-visible literals are
// stable structural log tokens (level names + go-style log format
...
// FUTURE user-facing string added to internal/logging/ inherits the
...
// migrations minimally invasive — Logger methods are called from
