...
import (
	...
	"dev.helix.code/internal/clarification/i18n"
)
...
// migration minimally invasive — Engine methods already take their
// own contexts, so threading a struct-scoped translator would inflate
...
func init() {
	...
	if err != nil {
		fmt.Fprintf(os.Stderr,
			"internal/clarification i18n: embedded-bundle translator load failed; "+
