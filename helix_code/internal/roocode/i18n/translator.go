// Package i18n declares internal/roocode's hardcoded-content
// abstraction per CONST-046 (round-236 §11.4 anti-bluff sweep,
// 2026-05-19). Mirrors the "consumer defines its own Translator
// interface" pattern of every prior CONST-046-migrated package in
// this codebase (most recently rounds 221..235). Wire-in path at
// boot: consuming binary builds an *i18n.Localizer (loaded with
// active.en.yaml from internal/roocode/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via roocode.SetTranslator. The
...
// Translator is the contract internal/roocode uses for every
