// translator.go — CONST-046 message-ID resolver seam for internal/cognee.
//
// Round-148 §11.4 anti-bluff sweep (2026-05-18). Mirrors the
// "consumer defines its own Translator + tr() helper" pattern used
// by every other CONST-046-migrated package in this codebase
// (rounds 93/94/95/96/108/131/134/136-147).
package cognee

import (
	"context"

	"dev.helix.code/internal/cognee/i18n"
)
...
// migration minimally invasive — CogneeManager methods already take
