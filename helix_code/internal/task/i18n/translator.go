// Package i18n declares internal/task's hardcoded-content
// abstraction per CONST-046 (round-240 §11.4 anti-bluff sweep,
// 2026-05-19). Mirrors the "consumer defines its own Translator
// interface" pattern of rounds 93..239 (most recently
// internal/theme 238, internal/telemetry 237, internal/sync 236,
// internal/state 235, internal/plugins 234, internal/hooks 160,
// internal/helixqa 159).
//
// Wire-in path at boot: consuming binary builds an *i18n.Localizer
// (loaded with active.en.yaml from internal/task/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// task.SetTranslator. The package-level tr() helper falls back
...
// Translator is the contract internal/task uses for every
