// Package i18n declares internal/mcp's hardcoded-content
// abstraction per CONST-046 (round-164 §11.4 anti-bluff sweep,
...
// (loaded with active.en.yaml from internal/mcp/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// mcp.SetTranslator. The package-level tr() helper falls back
...
// Translator is the contract internal/mcp uses for every
