// Package i18n declares internal/focus's hardcoded-content
// abstraction per CONST-046 (round-157 §11.4 anti-bluff sweep,
// 2026-05-18). Mirrors the "consumer defines its own Translator
// interface" pattern of rounds 93..156 (most recently
...
// (loaded with active.en.yaml from internal/focus/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// focus.SetTranslator. The package-level tr() helper falls back to
...
// Translator is the contract internal/focus uses for every
