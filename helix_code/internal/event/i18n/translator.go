// Package i18n declares internal/event's hardcoded-content
// abstraction per CONST-046 (round-156 §11.4 anti-bluff sweep,
...
// (rounds 93..155 — most recently internal/discovery 154,
// internal/editor 155). Wire-in path at boot: consuming binary
// builds an *i18n.Localizer (loaded with active.en.yaml from
// internal/event/i18n/bundles), wraps it in *i18nadapter.Translator,
// stores via event.SetTranslator. The package-level tr() helper
...
// Translator is the contract internal/event uses for every
