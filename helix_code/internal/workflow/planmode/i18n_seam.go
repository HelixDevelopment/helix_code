// CONST-046 i18n seam for the internal/workflow/planmode package.
...
// canonical accessor used by every CONST-046-migrated phase /
// status string in internal/workflow/planmode.
