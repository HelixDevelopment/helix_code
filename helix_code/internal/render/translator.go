...
var (
	...
	// loads, or renderi18n.NoopTranslator{} (loud message-ID echo) if it
	// does not. SetTranslator(nil) restores THIS — "nil = restore default"
	// means "restore correct prose", not "revert to raw-key echo".
	defaultTranslator renderi18n.Translator = renderi18n.NoopTranslator{}
...
func init() {
	tr, err := renderi18n.NewTranslator()
	if err != nil {
		fmt.Fprintf(os.Stderr,
			"internal/render i18n: embedded-bundle translator load failed; "+
