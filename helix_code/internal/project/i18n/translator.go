// Package i18n declares internal/project's hardcoded-content
// abstraction per CONST-046 (round-170 §11.4 anti-bluff sweep,
...
// internal/commands 149, internal/cognee 148, internal/agent 147,
// internal/auth 146). Wire-in path at boot: the consuming binary
// builds an *i18n.Localizer (loaded with active.en.yaml from
// internal/project/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via project.SetTranslator. The
...
// Translator is the contract internal/project uses for every
