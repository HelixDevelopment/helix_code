// Package i18n declares internal/hardware's hardcoded-content
// abstraction per CONST-046 (round-158 §11.4 anti-bluff sweep,
// 2026-05-18). Mirrors the "consumer defines its own Translator
// interface" pattern of rounds 93..157 (most recently
...
// (loaded with active.en.yaml from internal/hardware/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// hardware.SetTranslator. The package-level tr() helper falls back
...
// Translator is the contract internal/hardware uses for every
