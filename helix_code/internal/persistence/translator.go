...
var (
	...
	// loads, or persistencei18n.NoopTranslator{} (loud message-ID echo) if it
	// does not. SetTranslator(nil) restores THIS — "nil = restore default"
	// means "restore correct prose", not "revert to raw-key echo".
	defaultTranslator persistencei18n.Translator = persistencei18n.NoopTranslator{}
...
func init() {
	tr, err := persistencei18n.NewTranslator()
	if err != nil {
		fmt.Fprintf(os.Stderr,
			"internal/persistence i18n: embedded-bundle translator load failed; "+
