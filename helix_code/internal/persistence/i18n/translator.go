// Package i18n declares internal/persistence's hardcoded-content
// abstraction per CONST-046 (round-169 §11.4 anti-bluff sweep,
// 2026-05-19). Mirrors the "consumer defines its own Translator
// interface" pattern of rounds 93..168 (most recently
...
// (loaded with active.en.yaml from internal/persistence/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// persistence.SetTranslator. The package-level tr() helper falls back
...
// Translator is the contract internal/persistence uses for every
