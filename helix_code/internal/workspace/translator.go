// translator.go — CONST-046 message-ID resolver seam for internal/workspace.
//
// Round-241 §11.4 anti-bluff sweep (2026-05-19). Mirrors the
...
// internal/projectmemory, internal/voice, internal/roocode, …).
package workspace

import (
	"context"

	"dev.helix.code/internal/workspace/i18n"
)
...
// migration minimally invasive — the workspace surface (tool
// invocations, schema descriptions, validate errors) reads from
// this pointer on every user-visible string emission; threading a
// translator through every constructor would inflate every
// workspace API for no behavioural gain.
