// Package i18n declares internal/planner's hardcoded-content
// abstraction per CONST-046 (round-232 §11.4 anti-bluff sweep,
...
// active.en.yaml from internal/planner/i18n/bundles), wraps it in
// *i18nadapter.Translator, stores via planner.SetTranslator. The
...
// Translator is the contract internal/planner uses for every
