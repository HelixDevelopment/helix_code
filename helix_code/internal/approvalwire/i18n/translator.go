// Package i18n declares internal/approvalwire's hardcoded-content
// abstraction per CONST-046 (round-228 §11.4 anti-bluff sweep,
// 2026-05-19). Mirrors the "consumer defines its own Translator
// interface" pattern of every prior CONST-046-migrated package in
// this codebase (most recently rounds 221..226). Wire-in path at
// boot: consuming binary builds an *i18n.Localizer (loaded with
// active.en.yaml from internal/approvalwire/i18n/bundles), wraps
// it in *i18nadapter.Translator, stores via approvalwire.SetTranslator.
...
// Translator is the contract internal/approvalwire uses for every
