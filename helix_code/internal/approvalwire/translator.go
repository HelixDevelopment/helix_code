...
// internal/approvalwire.
//
// Round-228 §11.4 anti-bluff sweep (2026-05-19). Mirrors the
...
import (
	...
	"dev.helix.code/internal/approvalwire/i18n"
)
...
// migration minimally invasive — the AskUserYesNoPrompter is a thin
// adapter and threading a translator through every PromptYesNo call
// would inflate the signature; the package-level seam keeps it
...
func init() {
	...
	if err != nil {
		fmt.Fprintf(os.Stderr,
			"internal/approvalwire i18n: embedded-bundle translator load failed; "+
