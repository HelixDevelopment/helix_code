// Package i18n declares internal/helixqa's hardcoded-content
// abstraction per CONST-046 (round-159 §11.4 anti-bluff sweep,
...
// 153, internal/database 152, internal/context 151,
// internal/config 150).
//
// Wire-in path at boot: consuming binary builds an *i18n.Localizer
// (loaded with active.en.yaml from internal/helixqa/i18n/bundles),
// wraps it in *i18nadapter.Translator, stores via
// helixqa.SetTranslator. The package-level tr() helper falls back
...
// Translator is the contract internal/helixqa uses for every
