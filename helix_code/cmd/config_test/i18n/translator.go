// Package i18n declares config_test's hardcoded-content abstraction
// per CONST-046 (round-141 §11.4 anti-bluff sweep, 2026-05-18).
//
// config_test is a tiny CLI living inside the dev.helix.code module
...
// by rounds 93/94/95/96/108/131/134/136-140 (Lazy / SelfImprove /
// HelixLLM / harmony_os / helix_config / helixllm / cli / server /
// desktop / terminal_ui / ios / android / aurora_os) for three
...
// (3) future extraction of config_test into its own submodule would
// not require restructuring the i18n surface.
//
// The wire-in path at boot is: config_test constructs an
...
// Translator is the contract config_test uses for every CONST-046-
