// Package i18n declares security_fix's hardcoded-content abstraction
// per CONST-046 (round-143 §11.4 anti-bluff sweep, 2026-05-18).
//
// security_fix is a tiny CLI living inside the dev.helix.code module
...
// by rounds 93/94/95/96/108/131/134/136-142 (Lazy / SelfImprove /
// HelixLLM / harmony_os / helix_config / helixllm / cli / server /
// desktop / terminal_ui / ios / android / aurora_os / config_test /
// security_test) for three reasons: (1) uniform pattern across the
...
// pkg/i18n's bundle-loading, (3) future extraction of security_fix
// into its own submodule would not require restructuring the i18n
// surface.
//
// The wire-in path at boot is: security_fix constructs an
...
// Translator is the contract security_fix uses for every CONST-046-
// migrated user-facing string.
