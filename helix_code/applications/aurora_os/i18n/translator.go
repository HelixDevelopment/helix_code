// Package i18n declares the aurora_os application's hardcoded-content
// abstraction per CONST-046 (round-140 §11.4 anti-bluff sweep,
// 2026-05-18).
//
// The aurora_os app is a Fyne-based desktop client targeting Aurora OS
// and lives inside the dev.helix.code module as `package main`
// (cmd-style entry point), so it COULD import
...
// by rounds 93/94/95/96/108/131/134/136/137/138/139 for three
...
// (3) future extraction of the aurora_os app into its own submodule
// would not require restructuring the i18n surface.
//
...
// the aurora_os app via SetTranslator (structural match — no shared
// package required).
package i18n

import "context"

// Translator is the contract the aurora_os app uses for every
