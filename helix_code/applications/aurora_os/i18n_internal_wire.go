...
// translators for every importable internal/* package on the aurora_os
// (GUI + nogui) entry path.
//
// The aurora_os binary never called i18nwiring.WireAll(), so the ~60
...
// CONST-046 / §11.4 regression on the aurora_os entry path.
//
