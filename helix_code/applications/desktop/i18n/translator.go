// Package i18n declares the desktop application's hardcoded-content
// abstraction per CONST-046 (round-136 §11.4 anti-bluff sweep,
// 2026-05-18).
//
// The desktop app is built on Fyne v2.7 and lives inside the
...
// bundle-loading, (3) future extraction of the desktop app into its
...
// the desktop app via SetTranslator (structural match — no shared
// package required).
package i18n

import "context"

// Translator is the contract the desktop app uses for every
